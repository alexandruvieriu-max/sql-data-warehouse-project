...
#### Specifications
- **Data Sources**: Import data from two source systems (ERP and CRM) porvided as CSV files.
- **Data Quality**: Cleanse and resolve data quality issues prior to analysis.
- **Interogation**: Combine both source into a single, user-friendly data model designed for analytical queries.
